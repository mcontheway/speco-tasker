...
Speco Tasker 中的任务遵循特定格式，旨在为开发人员提供全面的任务管理信息。

Tasks in Speco Tasker follow a specific format designed to provide comprehensive task management information for developers.
...
Speco Tasker 支持任务分解功能：

Speco Tasker supports task decomposition functionality:

### 任务扩展 | Task Expansion

您可以将复杂任务分解为更小的子任务：

You can break down complex tasks into smaller subtasks:
...
## 任务管理的最佳实践 | Best Practices for Task Management
