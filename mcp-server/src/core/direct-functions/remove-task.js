...
import { removeTask, taskExists } from '../../../../scripts/modules/task-manager.js'
import { disableSilentMode, enableSilentMode, readJSON } from '../../../../scripts/modules/utils.js'
...
export async function removeTaskDirect(args, log, context = {}) {
	...
	try {
		...
		const invalidTasks = taskIdArray.filter((taskId) => !taskExists(data.tasks, taskId))
