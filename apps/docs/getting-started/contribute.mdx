...
We welcome contributions from all developers. We expect you to:

- ✅ **Review and understand** what you're contributing
- ✅ **Test the code thoroughly** before submitting
- ✅ **Ensure it's well-written** and follows our patterns
- ❌ **Don't submit untested or unreviewed code**
...
```bash
git clone https://github.com/YOUR_USERNAME/speco-tasker.git
cd speco-tasker
npm install
```
