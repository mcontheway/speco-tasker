...
export class NotificationPreferences {
	...
	shouldShowNotification(category: ErrorCategory, severity: ErrorSeverity): boolean {
		...
		if (level === NotificationLevel.CRITICAL_ONLY && severity !== ErrorSeverity.CRITICAL) {
			return false
		}
	...
	private getNotificationLevel(): NotificationLevel {
		...
		return config.get<NotificationLevel>('notifications.level', NotificationLevel.ERRORS_ONLY)
	}
