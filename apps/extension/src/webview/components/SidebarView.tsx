...
export const SidebarView: React.FC<SidebarViewProps> = ({ initialConnectionStatus = false }) => {
	...
	return (
		<div className="h-full flex items-center justify-center p-6">
			<div className="text-center">
				...
				<h2 className="text-xl font-semibold mb-6 text-vscode-foreground">TaskMaster</h2>
