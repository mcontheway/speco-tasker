...
export const taskKeys = {
	...
	list: (filters: { tag?: string; status?: string }) => [...taskKeys.lists(), filters] as const,
...
export function useUpdateTask() {
	...
	return useMutation({
		...
		onSuccess: async (data, variables) => {
			...
			console.log('🔄 All task queries invalidated for task:', variables.taskId)
		}
	})
}
...
export function useUpdateSubtask() {
	...
	return useMutation({
		...
		onSuccess: async (data, variables) => {
			console.log('✅ Subtask update successful, invalidating all task queries')
			...
			console.log('🔄 All task queries invalidated for subtask:', variables.taskId)
		}
	})
}
...
export function useScopeUpTask() {
	...
	return useMutation({
		...
		onSuccess: async (data, variables) => {
			...
			console.log('🔄 All task queries invalidated for scoped up task:', variables.taskId)
		}
	})
}
...
export function useScopeDownTask() {
	...
	return useMutation({
		...
		onSuccess: async (data, variables) => {
			console.log('✅ Task scope down successful, invalidating all task queries')
			console.log('Task ID:', variables.taskId)
			...
			console.log('🔄 All task queries invalidated for scoped down task:', variables.taskId)
		}
	})
}
