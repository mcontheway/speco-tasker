...
- **Data Structure**: Tasks are organized into separate contexts (tags) like "main", "feature-branch", or "v2.0".
- **Silent Migration**: Existing projects automatically migrate to use a "main" tag with zero disruption.
...
1.  **`.taskmaster/config.json` File (Primary):**
    ...
    *   **Tagged System Settings**: Includes `global.defaultTag` (defaults to "main") and `tags` section for tag management configuration.
