...
describe('ProviderRegistry', () => {
	...
	describe('Provider Registration', () => {
		...
		test('registerProvider validates provider instance', () => {
			expect(() => registry.registerProvider('mock', null)).toThrow('Provider instance is required')
	...
	describe('Interface Validation', () => {
		test('validates generateText method exists', () => {
			...
			expect(() => registry.registerProvider('invalid', providerWithoutGenerateText)).toThrow(
				'Provider must implement BaseAIProvider interface'
			)
		})
		...
		test('validates streamText method exists', () => {
			...
			expect(() => registry.registerProvider('invalid', providerWithoutStreamText)).toThrow(
				'Provider must implement BaseAIProvider interface'
			)
		})
		...
		test('validates generateObject method exists', () => {
			...
			expect(() => registry.registerProvider('invalid', providerWithoutGenerateObject)).toThrow(
				'Provider must implement BaseAIProvider interface'
			)
		})
		...
		test('validates methods are functions', () => {
			...
			expect(() => registry.registerProvider('invalid', providerWithNonFunctionMethods)).toThrow(
				'Provider must implement BaseAIProvider interface'
			)
		})
		...
		test('accepts provider with all required methods', () => {
			...
			expect(() => registry.registerProvider('valid', validProvider)).not.toThrow()
		})
	})
