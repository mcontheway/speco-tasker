...
const mockFindTasksPath = jest.fn().mockReturnValue('/test/path/.taskmaster/tasks/tasks.json')
...
describe('MCP Cross-Tag Move Direct Function', () => {
	...
	describe('Mock Verification', () => {
		it('should verify that mocks are working', () => {
			...
			expect(mockFindTasksPath()).toBe('/test/path/.taskmaster/tasks/tasks.json')
	...
	describe('Parameter Validation', () => {
		...
		it('should return error when source tag is missing', async () => {
			...
			expect(result.error.message).toBe('Source tag is required for cross-tag moves')
		})
		...
		it('should return error when target tag is missing', async () => {
			...
			expect(result.error.message).toBe('Target tag is required for cross-tag moves')
		})
		...
		it('should return error when source and target tags are the same', async () => {
			...
			expect(result.error.message).toBe('Source and target tags are the same ("backlog")')
	...
	describe('Error Code Mapping', () => {
		...
		it('should map missing project root errors correctly', async () => {
			...
			expect(result.error.message).toBe('Project root is required if tasksJsonPath is not provided')
		})
	})
