...
describe("addTask - Manual Mode", () => {
	...
	beforeEach(() => {
		...
		jest
			.spyOn(utilsModule, "parseDependencies")
			.mockImplementation((input, tasks) => ({
	...
	describe("Manual task creation mode", () => {
		...
		test("should handle dependencies parsing correctly", async () => {
			...
			const manualTaskData = {
				...
				spec_files: [
					{ type: "spec", title: "Database Schema", file: "docs/db-schema.md" },
				],
			};
	...
	describe("Error handling", () => {
		...
		test("should handle file write errors", async () => {
			...
			const manualTaskData = {
				...
				testStrategy: "Test strategy",
				spec_files: [
					{ type: "spec", title: "Test Spec", file: "docs/test.md" },
				],
			};
			const context = {
				projectRoot: "/mock/project/root",
