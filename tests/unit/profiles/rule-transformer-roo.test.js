...
Also has references to .mdc files.`
		...
		const result = convertRuleToProfileRule('source.mdc', 'target.md', rooProfile)
...
[taskmaster.mdc](mdc:.cursor/rules/taskmaster.mdc).`
	...
	it('should handle file read errors', () => {
		...
		// Call the actual function
		const result = convertRuleToProfileRule('nonexistent.mdc', 'target.md', rooProfile)
	...
	it('should create target directory if it does not exist', () => {
		...
		// Call the actual function
		convertRuleToProfileRule('source.mdc', 'some/deep/path/target.md', rooProfile)
