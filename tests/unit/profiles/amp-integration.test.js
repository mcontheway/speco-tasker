...
describe('Amp Profile Integration', () => {
	...
	describe('AGENT.md Import Logic', () => {
		...
		test('should preserve existing content when adding import', () => {
			...
			const updatedContent = fs.readFileSync(path.join(tempDir, 'AGENT.md'), 'utf8')
	...
	describe('MCP Configuration Handling', () => {
		...
		test('should handle malformed JSON gracefully', () => {
			...
			fs.writeFileSync(path.join(vscodeDirPath, 'settings.json'), '{ malformed json')
	...
	describe('Error Handling', () => {
		test('should handle file system errors gracefully', () => {
			...
			const assetsDir = path.join(tempDir, 'assets')
			fs.mkdirSync(assetsDir, { recursive: true })
			originalWriteFileSync.call(fs, path.join(assetsDir, 'AGENTS.md'), 'Task Master instructions')
