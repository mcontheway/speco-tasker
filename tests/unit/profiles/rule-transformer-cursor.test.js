...
Also has references to .mdc files.`
		...
		const result = convertRuleToProfileRule('source.mdc', 'target.mdc', cursorProfile)
...
[taskmaster.mdc](mdc:.cursor/rules/taskmaster.mdc).`
		...
		expect(transformedContent).toContain('(mdc:.cursor/rules/taskmaster/dev_workflow.mdc)')
		expect(transformedContent).toContain('(mdc:.cursor/rules/taskmaster/taskmaster.mdc)')
	})
	...
	it('should handle file read errors', () => {
		...
		// Call the actual function
		const result = convertRuleToProfileRule('nonexistent.mdc', 'target.mdc', cursorProfile)
	...
	it('should create target directory if it does not exist', () => {
		...
		// Call the actual function
		convertRuleToProfileRule('source.mdc', 'some/deep/path/target.mdc', cursorProfile)
